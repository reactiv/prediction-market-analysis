...
|--------|----------|-------------|
| [§1.1](1_1_longshot_bias.md) | Longshot Bias | Contracts below 15c deliver -1.19 pp contract-weighted excess return to buyers; fading longshots earns 1.19 cents/contract across 6.17B contracts with a 95.2% win rate. |
| [§1.2](1_2_favourite_longshot_asymmetry.md) | Favourite-Longshot Asymmetry | YES takers lose -0.93 pp vs -0.61 pp for NO takers, a -0.32 pp gap after exact-price contract-weighting. |
| [§1.3](1_3_category_specific_miscalibration.md) | Category-Specific Miscalibration | Politics is the most miscalibrated category (MAE 13.11 pp), while Crypto is best calibrated (0.72 pp) -- roughly an 18x spread across groups. |
...
| [§3.4](3_4_volume_regime_switching.md) | Volume Regime Switching | High-volume markets (top tercile) achieve 1.43 pp MAE vs 4.83 pp for medium-volume; the relationship remains non-monotonic with medium-volume worst calibrated. |
...
| [§6.3](6_3_yes_bias.md) | Yes Bias | YES takers outnumber NO takers 2.23:1 overall (46.8M vs 21.0M trades), peaking at ~4:1 in the 20-35c range, and underperform NO by 0.32 pp contract-weighted. |
...
| [§7.2](7_2_smart_money_informed_calibration.md) | Smart-Money-Informed Calibration | Smart money earns +35.0 pp buying at similar prices where naive longshot buyers lose -1.19 pp (fade earns +1.19 c/contract), implying selective longshot picking informed by wallet flow can vastly outperform blanket strategies. |
